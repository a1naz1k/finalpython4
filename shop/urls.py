...
urlpatterns = [
    ...
    path('users/', UserProfileSimplViewSet.as_view({'get': 'list', 'post': 'create'}), name='user_list'),
    path('users/<int:pk>/', UserProfileSimplViewSet.as_view({'get': 'retrieve', 'put': 'update',
